...
import { Button, Checkbox, Label, TextInput, Carousel } from "flowbite-react";
        ...
        <div className="flex h-screen">
            ...
            <div className="w-full lg:w-1/2 flex justify-center ">
                <form className="flex flex-col gap-4 w-full max-w-md p-6 bg-white rounded-md">
                    ...
                    <h1 className="text-2xl font-semibold text-center mb-10">Room Management System</h1>
                    ...
                    <Button className=" bg-sky-500 hover:bg-sky-600" type="submit"  onClick={handleSubmit}>
                        Submit
                    </Button>
                </form>
            </div>
